...
public class FindByCurrencyMessageProcessorDebuggable
    extends FindByCurrencyMessageProcessor
    implements DebugInfoProvider
{


    public FindByCurrencyMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("currency", "Currency", (java.lang.String.class), currency, muleEvent));
