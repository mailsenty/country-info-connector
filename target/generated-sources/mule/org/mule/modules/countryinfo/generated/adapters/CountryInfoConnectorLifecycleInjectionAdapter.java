...
/**
 * A <code>CountryInfoConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link CountryInfoConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-08-26T12:46:43-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class CountryInfoConnectorLifecycleInjectionAdapter
    extends CountryInfoConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(CountryInfoConnectorLifecycleInjectionAdapter.class);
