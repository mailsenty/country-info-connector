...
public class FindOnLangMessageProcessorDebuggable
    extends FindOnLangMessageProcessor
    implements DebugInfoProvider
{


    public FindOnLangMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("lang", "Lang", (java.lang.String.class), lang, muleEvent));
