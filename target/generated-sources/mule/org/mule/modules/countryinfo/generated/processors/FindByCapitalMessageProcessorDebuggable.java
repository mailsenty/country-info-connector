...
public class FindByCapitalMessageProcessorDebuggable
    extends FindByCapitalMessageProcessor
    implements DebugInfoProvider
{


    public FindByCapitalMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("capital", "Capital", (java.lang.String.class), capital, muleEvent));
